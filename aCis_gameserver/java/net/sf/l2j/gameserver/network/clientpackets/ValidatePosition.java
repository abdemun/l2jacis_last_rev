...
public class ValidatePosition extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar.isInBoat())
		{
			...
			{
				dx = _x - activeChar.getBoatPosition().getX();
				dy = _y - activeChar.getBoatPosition().getY();
				dz = _z - activeChar.getBoatPosition().getZ();
				diffSq = (dx * dx + dy * dy);
				if (diffSq > 250000)
					sendPacket(new GetOnVehicle(activeChar.getObjectId(), _data, activeChar.getBoatPosition()));
			}
			return;
		}
