...
public class Clan
{
	...
	private static final String UPDATE_CLAN = "UPDATE clan_data SET leader_id=?,ally_id=?,ally_name=?,reputation_score=?,ally_penalty_expiry_time=?,ally_penalty_type=?,char_penalty_expiry_time=?,dissolving_expiry_time=? WHERE clan_id=?";
	...
	/**
	 * Generate a new {@link ClanMember} based on a {@link Player}, and replace existing content. Refresh clan leader if needed.
